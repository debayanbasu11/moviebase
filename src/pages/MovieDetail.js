...
export const MovieDetail = () => {
    ...
    useEffect( () => {
        ...
        async function fetchMovie(){
            const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=e55afda2a93c165c627263a7eef838bc`);
        ...
        <main>
            <section className="flex justify-around flex-wrap py-5">
                ...
                <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
                    ...
                    <p className="my-4 lg:text-left">{movie.overview}</p>
